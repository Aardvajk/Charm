...
Action*
ActionList::add(const QString &group, const QString &name)
{
...
Action*
ActionList::find(const QString &group, const QString &name) const
{
...
QMap<QString, QList<Action*> >
ActionList::toMap() const
{
...
void
ActionList::loadFromSettings(Settings *settings)
{
...
void
ActionList::saveToSettings(Settings *settings) const
{
    settings->clear();
    for(int i = 0; i < data.count(); ++i)
    {
